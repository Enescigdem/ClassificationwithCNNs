...
Original file is located at
    https://colab.research.google.com/drive/1V85cKN-UmoZpcEr_FJnpFpJs7Nh1_eP3
"""
...
'''!unzip "/content/drive/MyDrive/chaoyang-data-20221128T182823Z-001.zip" -d "/content/drive/MyDrive/chaoyang-data/"
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/train" |  wc -l 
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/test" |  wc -l'''

jtrain = pd.read_json("/content/drive/MyDrive/chaoyang-data/chaoyang-data/train.json")
jtest = pd.read_json("/content/drive/MyDrive/chaoyang-data/chaoyang-data/test.json")
jtest.head()

print(jtrain['label'].value_counts())
print(jtest['label'].value_counts())



!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/train/0" |  wc -l 
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/train/1" |  wc -l 
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/train/2" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/train/3" |  wc -l

!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/test/0" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/test/1" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/test/2" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/test/3" |  wc -l

!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/valid/0" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/valid/1" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/valid/2" |  wc -l
!ls "/content/drive/MyDrive/chaoyang-data/chaoyang-data/valid/3" |  wc -l
...
dataset_directory = '/content/drive/MyDrive/chaoyang-data/chaoyang-data/'
image_datasets = {x: datasets.ImageFolder(os.path.join(dataset_directory, x),data_transforms[x])for x in ['train', 'valid', 'test']}
...
print({x: len(image_datasets[x]) for x in ['train', 'valid','test']})
...
def train_model(model, criterion, optimizer, scheduler, epoch_number):
    ...
    for epoch in range(epoch_number):
        ...
        for part in ['train', 'valid', 'test']:
            ...
            if part == 'valid' and epoch_acc > best_val_acc:
...
training_model.fc = nn.Linear(num_ftrs, 4) 
